...
<script>
			document.title = "Contact | Float restaurant"
		</script>
				...
				<div class="container">
					...
					<div class="row py-4">
						<div class="col-lg-6">
							...
							<form class="contact-form" action="php/contact-form.php" method="POST" id="contactform1">
						...
						<div class="col-lg-6">
							...
							<div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="800">
								...
								<ul class="list list-icons list-icons-style-2 mt-2">
									<li><i class="fas fa-map-marker-alt top-6"></i> <strong class="text-dark">Address:</strong> Nikole Tesle 12345, Serbia</li>
									<li><i class="fas fa-phone top-6"></i> <strong class="text-dark">Phone:</strong> +381 456-789</li>
									<li><i class="fas fa-envelope top-6"></i> <strong class="text-dark">Email:</strong> <a href="#"><span class="__cf_email__" data-cfemail="8ae7ebe3e6caeff2ebe7fae6efa4e9e5e7">float@rest.com</span></a></li>
								</ul>
							</div>
							...
							<div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="950">
								...
								<ul class="list list-icons list-dark mt-2">
									<li><i class="far fa-clock top-6"></i> Monday - Friday - 10am to 11pm</li>
									<li><i class="far fa-clock top-6"></i> Saturday - 11am to 8pm</li>
